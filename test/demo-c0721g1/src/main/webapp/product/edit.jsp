                ...
                <div class="row mt-2">
                    <div class="col-5">
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="id" value="${requestScope['product'].id}" disabled>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-4">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="name" value="${requestScope['product'].name}" aria-describedby="nameError">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="price" value="${requestScope['product'].price}" aria-describedby="priceError">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="quantity" value="${requestScope['product'].quantity}" aria-describedby="quantityError">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="color" value="${requestScope['product'].color}" aria-describedby="colorError">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name="description" value="${requestScope['product'].description}" aria-describedby="descriptionError">
                            ...
                            <div class="col-8">
                                <select class="form-select" aria-label="Default select example" name="categoryId" required>
                                    ...
                                    <c:forEach items="${categoryList}" var="category">
                                        <c:choose>
                                            <c:when test="${category.idCategory == product.categoryId}">
